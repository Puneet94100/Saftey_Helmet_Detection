...
OUTPUT_PATH = r"D:\sahfety_helmet_data"
DATA_PATH = r"D:\saftey_gear_data"

path = glob(r"D:\saftey_gear_data\annotations\*.xml")
...
train_df['path'] = f"D:\saftey_gear_data\images\{train_df['filename']}"
